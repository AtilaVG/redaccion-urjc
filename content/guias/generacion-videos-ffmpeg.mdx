...
excerpt: >-
  Desde la OfiLibre hemos generado una serie de scripts para automatizar la
  generación de vídeos usando FFmpeg
cover: /media/images/guias/ffmpeg.png
...
Este es el más elaborado de los tres. Está pensado para la edición de los vídeos pertenecientes a nuestra serie _Cafés con OfLibre_. El montaje final combina varios segmentos:
