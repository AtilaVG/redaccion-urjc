...
excerpt: Café y Creative Commons con OfiLibre en Biblioteca
cover: /media/images/blog/cafe-creative-commons/cc20-square.png
...
Vente el viernes 29 a la Biblioteca de Fuenlabrada, y celebra con nosotros la [Semana del Acceso Abierto](http://www.openaccessweek.org/). Esta actividad que abre la serie "Cafés con la OfiLibre en la Biblioteca", organizada conjuntamente por la [Biblioteca](https://www.urjc.es/estudiar-en-la-urjc/biblioteca) y la [OfiLibre](https://ofilibre.urjc.es/), que irá visitando los campus de la URJC durante los próximos meses.
