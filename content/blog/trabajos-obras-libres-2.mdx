...
excerpt: >-
  No todo lo que está disponible en Internet es libre para que lo usemos, pero
  si lo sabes buscar, hay mucho que sí: las obras libres. En este tipo de obras,
  el autor te ha dado dado permiso para que puedas usarlas y reutlizarlas sin
  problemas.
cover: /media/images/blog/trabajos-obras-libres/cabecera-square-2.png
...
- Transparencias: [PDF](https://gitlab.com/ofilibre/ofilibre.gitlab.io/-/raw/master/local/transpas/trabajos-obras-libres/Trabajos_Obras_libres-Consorcio.pdf), [formatio ODP para LibreOffice](https://gitlab.com/ofilibre/ofilibre.gitlab.io/-/raw/master/local/transpas/trabajos-obras-libres/Trabajos_Obras_libres-Consorcio.odp).

- Carteles: formato horizontal ([PDF](https://gitlab.com/ofilibre/ofilibre.gitlab.io/-/raw/master/local/transpas/trabajos-obras-libres/cartel_obras_libres_horizontal.pdf), [documento fuente para LibreOffice](https://gitlab.com/ofilibre/ofilibre.gitlab.io/-/raw/master/local/transpas/trabajos-obras-libres/cartel_obras_libres_horizontal.odg)), formato vertical ([PDF](https://gitlab.com/ofilibre/ofilibre.gitlab.io/-/raw/master/local/transpas/trabajos-obras-libres/cartel_obras_libres_vertical.pdf), [documento fuente para LibreOffice](https://gitlab.com/ofilibre/ofilibre.gitlab.io/-/raw/master/local/transpas/trabajos-obras-libres/cartel_obras_libres_vertical.odg))
