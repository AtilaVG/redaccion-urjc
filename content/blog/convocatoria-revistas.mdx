...
excerpt: >-
  Se pone en marcha la convocatoria de apoyo a la creación y mantenimiento de
  revistas académicas de la URJC. Se podrán presentar solicitudes durante todo
  el año.
cover: /media/images/mini-tevistas.png
...
- Convocartoria de apoyo a la publicación de revistas: [en el tablón de aununcios](https://sede.urjc.es/tablon-oficial/anuncio/9739/), [documento con el texto completo de la convocatoria](/media/documentos/convocatoria-revistas-2023.pdf).
