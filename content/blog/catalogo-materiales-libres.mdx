...
excerpt: >-
  Debido a la situación generada por el COVID-19, y el paso de las clases de la
  Universidad a modo 'a distancia', durante estos meses se han desarrollado
  muchos materiales docentes. En el proceso, hay muchos profesores que han
  querido aprovechar la oportunidad para publicarlos como materiales docentes
  libres, que podrían estar interesados en hacerlo en breve, o que tienen
  planeado hacerlo de cara al curso que viene.
