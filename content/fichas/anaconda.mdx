...
title: Anaconda
excerpt: ""
cover: /media/images/fichas/anaconda/logo.png
...
installs:
  - name: Cómo instalar Anaconda
    url: >-
      https://medium.com/@pandeysimran97/installing-anaconda-navigator-in-5-simple-steps-for-deep-learning-projects-c7c794f1768d
tutorials:
  - name: Videotutorial
...
screenshots:
  - name: Anaconda Navigator
    file: /media/images/fichas/anaconda/captura.png
    attribution: >-
      [Captura tomada de
      Wikipedia](https://docs.anaconda.com/_images/navigator-home-1-6.png)
  - name: Anaconda Navigator
    file: /media/images/fichas/anaconda/captura2.png
