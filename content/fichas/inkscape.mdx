...
title: Inkscape
excerpt: ""
cover: /media/images/fichas/inkscape/logo.png
...
screenshots:
  - name: inkscape en funcionamiento (captura)
    file: /media/images/fichas/inkscape/captura.png
  - name: inkscape en funcionamiento (captura)
    file: /media/images/fichas/inkscape/captura2.png
  - name: inkscape en funcionamiento (captura)
    file: /media/images/fichas/inkscape/captura3.png
  - name: inkscape en funcionamiento (captura)
    file: /media/images/fichas/inkscape/captura4.png
---
