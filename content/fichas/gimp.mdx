...
title: Gimp
excerpt: ""
cover: /media/images/fichas/gimp/logo.png
...
screenshots:
  - name: Gimp en funcionamiento (captura)
    file: /media/images/fichas/gimp/captura.png
    attribution: >-
      [Captura tomada de
      Wikipedia](https://es.wikipedia.org/wiki/GIMP#/media/File:GIMP_2.8.png),
      por C. Nilsson, licencia GFDL
  - name: Panel de herramientas (captura)
    file: /media/images/fichas/gimp/captura-herramientas.png
  - name: Panel de filtros (captura)
    file: /media/images/fichas/gimp/captura-filtros.png
---
