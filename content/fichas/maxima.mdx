...
title: Maxima
excerpt: ""
cover: /media/images/fichas/maxima/logo.png
...
screenshots:
  - name: Línea de comandos de Maxima (captura)
    file: /media/images/fichas/maxima/command-line.png
    attribution: >-
      [Captura tomada del wordpress
      mvngu](https://mvngu.wordpress.com/2009/08/17/introducing-maxima/)
  - name: Interfaz gráfica wxMaxima (captura)
    file: /media/images/fichas/maxima/wxmaxima-interface.png
    attribution: >-
      [Captura tomada de Wikimedia
      Commons](https://commons.wikimedia.org/wiki/File:WxMaxima_0.7.1_screenshot.png)
---
