...
title: Netbeans
excerpt: ""
cover: /media/images/fichas/netbeans/logo.png
...
tutorials:
  - name: Tutorial sobre Netbeans
    url: >-
      https://www.youtube.com/watch?v=jJd6Pl4xTuQ&list=PLMTiAh6qhda3emws2jBAiFl-luqFeSDvX
    kind: video
others:
...
screenshots:
  - name: Netbeans en funcionamiento (captura)
    file: /media/images/fichas/netbeans/captura.png
---
