...
title: OpenOffice
excerpt: ""
cover: /media/images/fichas/openoffice/logo.png
...
tutorials:
  ...
  - name: Tutorial de Math
    url: >-
      https://www.youtube.com/watch?v=Lq3_XVxc6iM&list=PLu5LXaMUM_E1VgEoqXBsu758fB8FDymts
    kind: video
screenshots:
  - name: Gimp en funcionamiento (captura)
    file: /media/images/fichas/openoffice/captura1.png
  - name: Gimp en funcionamiento (captura)
    file: /media/images/fichas/openoffice/captura2.png
  - name: Gimp en funcionamiento (captura)
    file: /media/images/fichas/openoffice/captura3.png
  - name: Gimp en funcionamiento (captura)
    file: /media/images/fichas/openoffice/captura4.png
  - name: Gimp en funcionamiento (captura)
    file: /media/images/fichas/openoffice/captura5.png
  - name: Gimp en funcionamiento (captura)
    file: /media/images/fichas/openoffice/captura6.png
---
